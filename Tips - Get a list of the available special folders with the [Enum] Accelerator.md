...
>[Bonus] : Get all accelerators available (and sort by key)
```` powershell
[psobject].Assembly.GetType("System.Management.Automation.TypeAccelerators")::Get | sort key
````
...
[06:46:10] C:/Temp> [double]::MaxValue
1,79769313486232E+308

[06:46:40] C:/Temp> [int16]::
Nom de propriété manquant après l’opérateur de référence.
    + CategoryInfo          : ParserError: (:) [], ParentContainsErrorRecordException
    + FullyQualifiedErrorId : MissingPropertyName


[06:47:05] C:/Temp> [psobject].Assembly.GetType("System.Management.Automation.TypeAccelerators")::Get | sort key
